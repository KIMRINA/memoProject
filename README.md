...
&nbsp;&nbsp;부족한 부분이 많은 프로젝트인 것 같지만, 귀엽게 봐주셨으면 합니다. 본 프로젝트의 레벨은 저마다의 시각마다 소박다거나, 미약하다고 느껴질 수 있겠지만, 저는 이 프로젝트를 통해서 혼자의 힘으로 구현하고 배울 수 있는 값진 시간의 프로젝트 였던 것 같습니다. 이상입니다. 읽어주셔서 감사합니다.<br>
<br>
